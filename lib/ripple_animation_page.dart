...
class RippleAnimationPage extends StatefulWidget {
  ...
  const RippleAnimationPage({Key key, this.size = 80.0, this.color = Colors.red,
...
class _RippleAnimationPageState extends State<RippleAnimationPage> with TickerProviderStateMixin{
